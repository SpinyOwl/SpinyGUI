...
import com.spinyowl.spinygui.backend.glfwutil.callback.chain.impl.*;
...
public class DefaultCallbackKeeper implements CallbackKeeper {
    ...
    private IChainWindowContentScaleCallback chainWindowContentScaleCallback = new ChainWindowContentScaleCallback();
    private IChainWindowMaximizeCallback chainWindowMaximizeCallback = new ChainWindowMaximizeCallback();
    ...
    /**
     * Returns chain callback used to keep {@link GLFWWindowContentScaleCallbackI} instances.
     *
     * @return chain char callback.
     */
    @Override
    public IChainWindowContentScaleCallback getChainWindowContentScaleCallback() {
        return chainWindowContentScaleCallback;
    }

    /**
     * Returns chain callback used to keep {@link GLFWWindowMaximizeCallbackI} instances.
     *
     * @return chain char callback.
     */
    @Override
    public IChainWindowMaximizeCallback getChainWindowMaximizeCallback() {
        return chainWindowMaximizeCallback;
    }
}
