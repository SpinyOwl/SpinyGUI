...
public final class FontStyle {
    ...
    /**
     * Used to find font style element with specified name. Note that name will be converted to
     * lower case and it should be the same as names of css font style property in css
     * specification.
     *
    ...
    /**
     * Used to create new font style element with specified name. Note that name will be converted
     * to lower case and it should be the same as names of css font style property in css
     * specification.
     *
     * @param name name of font style element.
    ...
    /**
     * Returns true there is a font style value wth specified name.
     *
     * @param name font style name.
     * @return true there is a font style value wth specified name.
     */
