...
public final class AlignSelf {
    ...
    /**
     * Used to find align-self element with specified name. Note that name will be converted to
     * lower case and it should be the same as names of css align-self property in css
     * specification.
     *
