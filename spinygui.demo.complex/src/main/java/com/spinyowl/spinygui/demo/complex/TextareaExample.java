...
public class TextareaExample extends Demo {

  private static final String XML_RESOURCE = "com/spinyowl/spinygui/demo/textarea-demo.xml";
  private static final String CSS_RESOURCE = "com/spinyowl/spinygui/demo/textarea-demo.css";

  public TextareaExample() {
    super(560, 340, "Textarea Example", new NvgRenderer());
  }

  public static void main(String[] args) {
    Demo demo = new TextareaExample();
    demo.run();
  }
