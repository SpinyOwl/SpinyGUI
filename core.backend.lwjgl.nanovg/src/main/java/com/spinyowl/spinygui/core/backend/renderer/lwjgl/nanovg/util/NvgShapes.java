 ...
 *
 * <p>Created by ShchAlexander on 19.09.2017.
 */
public class NvgShapes {

  public static final Vector4fc ZERO_CORNERS = new Vector4f(0);
   ...
   */
  public static void drawRect(long nvg, Vector2fc position, Vector2fc size, Color bgColor) {
    if (bgColor.a() <= MIN_ALPHA) {
      return;
    }
   ...
   * @param bgColor rectangle background color.
   */
  public static void drawRect(long nvg, Vector4fc rectangle, Color bgColor) {
    if (bgColor.a() <= MIN_ALPHA) {
      return;
    }
    try (NVGColor fillColor = NvgColorUtil.create(bgColor)) {
  ...
  public static void drawRect(
      long nvg, Vector2fc position, Vector2fc size, Color bgColor, float radius) {
    if (bgColor.a() <= MIN_ALPHA) {
      return;
    }
    try (NVGColor fillColor = NvgColorUtil.create(bgColor)) {
   ...
   */
  public static void drawRect(
      long nvg, Vector2fc position, Vector2fc size, Color bgColor, Vector4f radius) {
    if (bgColor == null || bgColor.a() <= MIN_ALPHA) {
      return;
    }
    if (radius != null && !radius.equals(ZERO_CORNERS)) {
      try (NVGColor fillColor = NvgColorUtil.create(bgColor)) {
        nvgBeginPath(nvg);
        nvgFillColor(nvg, fillColor);
   ...
   * @param radius cornder radius
   */
  public static void drawRect(long nvg, Vector4fc rectangle, Color bgColor, float radius) {
    if (bgColor.a() <= MIN_ALPHA) {
      return;
    }
    try (NVGColor fillColor = NvgColorUtil.create(bgColor)) {
   ...
   * @param radius cornder radius
   */
  public static void drawRect(long nvg, Vector4fc rectangle, Color bgColor, Vector4f radius) {
    if (radius != null && !radius.equals(ZERO_CORNERS)) {
      try (NVGColor fillColor = NvgColorUtil.create(bgColor)) {
        nvgBeginPath(nvg);
        nvgFillColor(nvg, fillColor);
  ...
  public static void drawRectStroke(
      long nvg, Vector2fc position, Vector2fc size, Color rectStrokeColor, float strokeWidth) {
    if (rectStrokeColor == null || rectStrokeColor.a() <= MIN_ALPHA) {
      return;
    }
   ...
   */
  public static void drawRectStroke(
      long nvg, Vector4fc rectangle, Color rectStrokeColor, float strokeWidth) {
    if (rectStrokeColor.a() <= MIN_ALPHA) {
      return;
    }
    try (NVGColor strokeColor = NvgColorUtil.create(rectStrokeColor)) {
      nvgBeginPath(nvg);
   ...
   */
  public static void drawRectStroke(
      long nvg, Vector4fc rectangle, Color rectStrokeColor, float strokeWidth, Vector4f radius) {
    if (radius != null && !radius.equals(ZERO_CORNERS)) {
      try (NVGColor strokeColor = NvgColorUtil.create(rectStrokeColor)) {
        nvgBeginPath(nvg);
        nvgStrokeColor(nvg, strokeColor);
   ...
   */
  public static void drawRectStroke(
      long nvg, Vector4fc rectangle, Color rectStrokeColor, float strokeWidth, float radius) {
    if (rectStrokeColor.a() <= MIN_ALPHA) {
      return;
    }
    try (NVGColor strokeColor = NvgColorUtil.create(rectStrokeColor)) {
   ...
   * @param lineCap line cap. One of: {@link org.lwjgl.nanovg.NanoVG#NVG_BUTT BUTT}, {@link
   *     org.lwjgl.nanovg.NanoVG#NVG_ROUND ROUND}, {@link org.lwjgl.nanovg.NanoVG#NVG_SQUARE
   *     SQUARE}, {@link org.lwjgl.nanovg.NanoVG#NVG_BEVEL BEVEL}, {@link
   *     org.lwjgl.nanovg.NanoVG#NVG_MITER MITER}
   ...
   */
  public static void drawLine(
      long nvg, float width, Color color, int lineCap, Vector2fc from, Vector2fc to) {
