...
| [E2: Frame runtime integration](work/E2%20-%20Frame%20runtime%20integration.md) | Consolidate owner-native frame contracts and provide an optional backend-independent pipeline plus reusable LWJGL application host. | Complete with verification caveat | M1-M4 are implemented and accepted; navigation, modal top-layer behavior, callback coexistence, and first-valid-frame rendering are verified. The epic retains its explicitly recorded native and aggregate verification caveats; no planned E2 implementation boundary remains. |
| [E3: CSS Grid support](work/E3%20-%20CSS%20Grid%20support.md) | Deliver a first-class, bounded CSS Grid Level 1 formatting context. | In progress | M7 plans bounded container alignment and stable intrinsic sizing for complex panels; edge-case grammar, Level 2 features, and broader proof remain explicitly deferred. |
